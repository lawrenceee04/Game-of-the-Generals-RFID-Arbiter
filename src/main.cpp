...
#define WHITE_GREEN_LED D1
// #define WHITE_BLUE_LED  D0

#define BLACK_GREEN_LED D2
...
byte blackPiece[21][7] = {
  {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
  {0x1D, 0x1E, 0xCB, 0xDA, 0x05, 0x10, 0x80},
  {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
  {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
  {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
  {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
...
void blackPieceWins() {
  digitalWrite(BLACK_GREEN_LED, HIGH);
  digitalWrite(WHITE_GREEN_LED, LOW);
  delay(2000);
};

void whitePieceWins() {
  digitalWrite(WHITE_GREEN_LED, HIGH);
  digitalWrite(BLACK_GREEN_LED, LOW);
  delay(2000);
};
...
void setup() {
  ...
  pinMode(WHITE_GREEN_LED, OUTPUT);
  pinMode(BLACK_GREEN_LED, OUTPUT);
}
